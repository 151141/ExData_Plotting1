...
plot2 <- plot(subsetted$Time, subsetted$Global_active_power, xlab = " ", ylab = "Global Active Power (kilowatts)", pch=19, type = "l", lwd = 1)


plot2 <- plot(subsetted$Time, subsetted$Global_active_power, xlab = " ", ylab = "Global Active Power (kilowatts)", pch=19, type = "l", lwd = 1)

png(file = "plot2.png")
with(subsetted, plot(subsetted$Time, subsetted$Global_active_power, xlab = " ", ylab = "Global Active Power (kilowatts)", pch=19, type = "l", lwd = 2))
dev.off()